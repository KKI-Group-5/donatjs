...
public class CampaignController {
    ...
    public CampaignController(CampaignService campaignService, UserModerationService moderationService) {
        ...
        if (auth != null && auth.getPrincipal() instanceof OAuth2User oauth) {
            ...
            if (moderationService.isUserSuspended(email)) {
                redirectAttributes.addFlashAttribute("error",
                        "Your account is suspended. You cannot create campaigns.");
